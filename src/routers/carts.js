...
carts.get('/', cartsController.getCarts.bind(cartsController));
carts.get('/:cid', cartsController.getCartById.bind(cartsController));
carts.post('/:cid/:pid', cartsController.addProductToCart.bind(cartsController));
carts.post('/:cid/purchase', cartsController.purchaseCart.bind(cartsController));
carts.delete('/:cid/products/:pid', cartsController.removeProductFromCart.bind(cartsController));
carts.put('/:cid/products/:pid', cartsController.updateProductQuantity.bind(cartsController));
carts.delete('/:cid', cartsController.clearCart.bind(cartsController));
