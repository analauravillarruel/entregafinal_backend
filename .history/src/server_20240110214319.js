const dotenvrequire('dotenv').config();
...
const initializeGitHubStrategy = require('./Config/githubStrategy');
const initializeLocalRegisterStrategy = require('./Config/localRegisterStrategy');
const initializeLocalLoginStrategy = require('./Config/localLoginStrategy');
const { initializeJWTStrategy, passportCall } = require('./Config/jwtStrategy');
...
const sessionRouter = require('./routers/'); // Asegúrate de que la ruta sea correcta
